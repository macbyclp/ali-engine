...
`ssao_intensity` (~1.1), `fxaa` (kenar yumuşatma), `exposure` (~1.0), `bloom` (~0.04), `vignette` (~0.25), `tonemap` (`aces`/`reinhard`/`linear`). SSAO ekran-uzayı ambient occlusion — temas/oyuk
